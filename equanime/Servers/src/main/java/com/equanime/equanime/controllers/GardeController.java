...
public class GardeController {
	...
	public String montarGradeHoraria(@RequestBody String value) throws org.json.simple.parser.ParseException{
		...
		Integer id_disciplina, disciplina, periodo;
		String  dia, hora;
